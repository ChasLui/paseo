...
| [docs/artifact-fs-evaluation.md](docs/artifact-fs-evaluation.md) | ArtifactFS feasibility study — why its network hydration doesn't help local worktrees, and what to borrow instead              |
